...
type Character struct {
	colorBackground, colorForeground, positionX, positionY int
	code byte
}
...
type Ansi struct {
	...
	colorBackground, colorForeground, positionX, positionY, savedPositionX, savedPositionY, sizeX, sizeY int
	character byte
	bold bool
}

// Initialize IBM PC 80x25 font data
func (a *Ansi) SetFont() {
...
func (a *Ansi) SetPalette() {
	a.palette = [16]color.RGBA{color.RGBA{0, 0, 0, 255}, color.RGBA{170, 0, 0, 255}, color.RGBA{0, 170, 0, 255}, color.RGBA{170, 85, 0, 255}, color.RGBA{0, 0, 170, 255}, color.RGBA{170, 0, 170, 255}, color.RGBA{0, 170, 170, 255}, color.RGBA{170, 170, 170, 255}, color.RGBA{85, 85, 85, 255}, color.RGBA{255, 85, 85, 255}, color.RGBA{85, 255, 85, 255}, color.RGBA{255, 255, 85, 255}, color.RGBA{85, 85, 255, 255}, color.RGBA{255, 85, 255, 255}, color.RGBA{85, 255, 255, 255}, color.RGBA{255, 255, 255, 255}}

	// Initialize default foreground color (For ASCII rendering)
	a.colorForeground = 7
}
